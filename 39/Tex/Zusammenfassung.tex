...
Zudem wurde der Ummagnetisierungsverlust auf bestimmt: $\omega_{verlust, H2} = 3.88 \pm 0.68 \, \frac{mJ}{kg}$\\
...
Der Flachstahlkern zeigte mit $B_r = 0.5261 \pm 0.00018 \, T$ und $H_c = 344.9 \pm 1.9 \, A/m$
...
Ebenso wurde auch hier der Ummagnetisierungsverlust bestimmt: $\omega_{verlust, Eisen} = 0.457 \pm 0.025 \, \frac{J}{kg}$\\
...
Die angegebenen Unsicherheiten ergeben sich überwiegend aus dem
...
Die starke Abweichung vom Literaturwert verdeutlicht, dass die
