...
Zudem wurde der Ummagnetisierungsverlust auf bestimmt: $\textcolor{red}{\omega}_{verlust, H2} = 3.88 \pm 0.68 \, \frac{mJ}{m^3}$\\
...
Ebenso wurde auch hier der Ummagnetisierungsverlust bestimmt: $\textcolor{red}{\omega}_{verlust, Eisen} = 1.25 \pm 0.11 \, \frac{mJ}{m^3}$\\
