\section{Auswertung}
    ...
    \end{equation*}
    \textcolor{red}{Der Wert wurde numerisch bestimmt und der zugehörige Fehler ergibt sich aus der Stichprobenstandardabweichung.} \\
    ...
    \textcolor{red}{Der Hauptfehler liegt allerdings darin, dass es Wechselwirkungen mit den Nachbarspulen gibt, welche trotz der Abwesenheit eines Stroms ein magnetisches Feld erzeugen.}
    ...
    \textcolor{red}{Hierzu wurde zuerst ein vollständiger Hystereseverlauf aufgezeichnet, an zwei Stellen am abnehmenden Zweig wird die Richtung durch Erhöhen der magnetischen Feldstärke umgekehrt.}
    ...
    \end{figure}
    \noindent \textcolor{red}{Mikroskopisch entstehen diese inneren Hystereseschleifen durch die
    ...
    \begin{equation*}
        \textcolor{red}{\omega}_{verlust, H2} = 3.88 \pm 0.68 \, \frac{mJ}{m^3} 
    \end{equation*}
    \begin{equation*}
        \textcolor{red}{\omega}_{verlust, Eisen} = \textcolor{red}{1.25 \pm 0.22} \, \frac{mJ}{m^3}
    \end{equation*}
