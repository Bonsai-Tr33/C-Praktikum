...
\label{subsec:VanDerWaalsGleichung}
    ...
    Die Einführung dieser Konstanten ist notwendig, da das ideale Gasmodell davon ausgeht, dass die Moleküle punktförmig und ohne Volumen sind. 
    ...
    Zusätzlich geht das ideale Gas-Modell davon aus, dass es keine zwischenmolekularen Kräfte gibt, wodruch die Beschreibung von Druck inpräzise wird. 
    ...
    Trotz der Verbesserung gegenüber der idealen Gasgleichung beschreibt das Van-der-Waals-Modell nicht alle Eigenschaften so wie sie experimentell beobachtet werden. 
