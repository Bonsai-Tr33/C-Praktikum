...
Protokollabgabe: 20. November 2025                 %Datum �ndern!
\vspace{1em}
\end{abstract}
}]
...
\section{Theorie}
	...
	\subsection{Wellenausbreitung auf Kabeln}
		...
		\subsubsection{Mathematische Beschreibung einer Welle} \label{MathWell}
			...
			In (\textcolor{blue}{HIER HYPERLINK ZU VERSUCH 2.1.2.2}) wird mithilfe eines sinusförmigen Signals eine stehende Welle im Koaxialkabel erzeugt.
			...
			\begin{equation*}
				v = \frac{1}{L*C*} = \frac{c}{\mu_r \epsilon_r}
...
\section{Experiment und Auswertung}
	...
	\subsection{Signalübertragung auf Koaxialkabel bei verschiedenartiger Anpassung}
		...
		Dazu wurde eine Peak-to-Peak-Spannung von $U_{pp} = 10V$ eingestellt und eine Amplitude von $U_{pp} = 20V$ am Oszilloskop beobachtet. 
		...
		Dadurch ergibt sich ein reflexionsfreier Abschluss und am Oszilloskop ist eine Amplitude von $U_{pp} = 10V$ abzulesen.\\
		...
		Zunächst wurde am Funktionsgenerator eine Frequenz $f = 200kHz$, eine Impulsbreite von $t = 20ns$ und eine Spannung von $U_{pp} = 10V$ eingestellt. Mittels T-Stecker
		wird das 50m lange Koaxialkabel sowohl mit dem Funktionsgenerator als auch mit dem Oszilloskop verbunden. Des weiteren schließt man an das generatorferne Ende des Kabels
		ein Kohleschichtpotentiometer. \\
		Nun wird der Widerstand solange verändert, bis keine Reflexion zu erkennen ist. Dieser Widerstand $R_v$ entspricht dann der Impedanz des Kabels. Der Widerstand wird mittels 
		Voltmeter gemessen.\\
		Bei der Messung ergab das ein Widerstand von $R_v = Z = (50 \pm 1)\Omega$. Der Fehler des Voltmeters wurde dem Datenblatt (\textcolor{blue}{HIER HYPERLINK ZU DATENBLATT}) entnommen.
		Das ist mit dem Literaturwert von $Z = 50\Omega$ vereinbar.


		\begin{figure}[h]
    		\centering
   			 \subfloat[\centering max. Reflexion, $R_v = 2,8\Omega$]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0013/F0013TEK.JPG} }}%
    		\qquad
   			 \subfloat[\centering keine Reflexion, $R_v = 50\Omega$]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0014/F0014TEK.JPG} }}%
			\qquad
   			 \subfloat[\centering wenig Reflexion, $R_v = 94,3\Omega$]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0015/F0015TEK.JPG} }}%
   			 \caption{Messung mit Kohleschichtpotentiometer}
   			 \label{AnpassungKohle}
		\end{figure}

		Des Weiteren wurde die Anpassung für ein Wendelpotentiometer und eine Widerstandsdekade durchgeführt. Dabei ließ sich der reflektierte Impuls allerdings nicht 
		vollständig unterdrücken wie in Abb. \ref{AnpassungWendel} und Abb. \ref{AnpassungDekade} zu erkennen ist.

		\begin{figure}[h]
    		\centering
   			 \subfloat[\centering  $R_v = 0,1\Omega$]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0016/F0016TEK.JPG} }}%
    		\qquad
   			 \subfloat[\centering $R_v = 50\Omega$]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0017/F0017TEK.JPG} }}%
			\qquad
   			 \subfloat[\centering $R_v = 100,1\Omega$]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0018/F0018TEK.JPG} }}%
		...
		\begin{figure}[h]
    		\centering
   			 \subfloat[\centering $R_v = 0\Omega$]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0019/F0019TEK.JPG} }}%
    		\qquad
   			 \subfloat[\centering $R_v = 50\Omega$]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0020/F0020TEK.JPG} }}%
			\qquad
   			 \subfloat[\centering $R_v = 100\Omega$]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0021/F0021TEK.JPG} }}%
   			 \caption{Messung mit Widerstandsdekade}
   			 \label{AnpassungDekade}
		\end{figure}

		Die Tatsache, dass die Reflexion nicht vollständig zu unterdrücken ist, ist dem Aufbau des Wendelpotentiometer geschuldet. Dieses beinhaltet nämlich ein
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=3cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0023/F0023TEK.JPG}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=3cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0022/F0022TEK.JPG}
			\caption{Anpassung mit Kurzschluss-Stecker}
			\label{AnpassungKurz}
		\end{figure}

		\subsubsection{Kombinatiuon von Abschlusswiderständen am Anfang und Ende des Kabels}
		...
		\hline
		 ...
		 $iii$ 			&     $0\Omega$ 		&     $\infty\Omega$ \\

		 $iv$ 			&     $50\Omega$ 		&     $0\Omega$ \\

		 $v$ 			&     $50\Omega$ 		&     $50\Omega$ \\

		 $vi$ 			&     $50\Omega$	 	&     $\infty\Omega$ \\

		 $vii$ 			&     $\infty\Omega$	&     $0\Omega$ \\

		 $viii$ 		&     $\infty\Omega$	&     $50\Omega$ \\

		 $ix$ 			&     $\infty\Omega$ 	&     $\infty\Omega$ \\
		...
		Wenn nun $R_a = 0\Omega$ wird hier das Signal am Kabelanfang reflektiert und invertiert und die Wellen überlagern sich (vgl. Abb. \ref{Kombi0}). 
		Wenn $R_a = Z$ ergibt sich mit dem Innenwiderstands des Funktionsgenerator 
		(vgl. Anleitung Funktionsgenerator\textcolor{blue}{HIER HYPERLINK ZU Funktionsgenerator HANDBUCH}) ein effektiver Widerstand von $R_{a,eff} = 25\Omega$
		...
		\begin{figure}[h]
    		\centering
   			 \subfloat[\centering i \label{i}]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0024/F0024TEK.JPG} }}%
    		\qquad
   			 \subfloat[\centering ii \label{ii}]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0025/F0025TEK.JPG} }}%
			\qquad
   			 \subfloat[\centering iii \label{iii}]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0026/F0026TEK.JPG} }}%
		...
		\begin{figure}[h]
    		\centering
   			 \subfloat[\centering iv \label{iv}]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0027/F0027TEK.JPG} }}%
    		\qquad
   			 \subfloat[\centering v \label{v}]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0028/F0028TEK.JPG} }}%
			\qquad
   			 \subfloat[\centering vi \label{vi}]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0029/F0029TEK.JPG} }}%
		...
		\begin{figure}[h]
    		\centering
   			 \subfloat[\centering vii \label{vii}]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0030/F0030TEK.JPG} }}%
    		\qquad
   			 \subfloat[\centering viii \label{viii}]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0031/F0031TEK.JPG} }}%
			\qquad
   			 \subfloat[\centering ix \label{ix}]{{\includegraphics[width=2cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0032/F0032TEK.JPG} }}%
		...
		\begin{figure}[h]
			\includegraphics[width=3.5cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0033/F0033TEK.JPG}
		\caption{Messung der Laufzeit, Koaxialkabel}
		\label{ZeitKoax}
		\end{figure}

		\begin{equation*}
			\Delta t_{Koaxialkabel} = (520 \pm \textcolor{red}{FEHLER})ns 
		\end{equation*}

		\begin{figure}[h]
			\includegraphics[width=3.5cm]{/home/hannes/Desktop/Uni/C1-Praktikum/C-Praktikum/41/Images/ALL0037/F0037TEK.JPG}
		\caption{Messung der Laufzeit, Verzögerungskabel}
		\label{ZeitVerz}
		\end{figure}

		\begin{equation*}
			\Delta t_{Verzögerungskabel} = (2,120 \pm \textcolor{red}{FEHLER})\mu s
		\end{equation*}

		Mithilfe der Länge L der Kabel lässt sich die Ausbreitungsgeschwindigkeit bestimmen:
		...
		\begin{displaymath}
			v_{Koaxialkabel} = (\textcolor{red}{WERT} \pm \textcolor{red}{FEHLER}) \frac{m}{s}
		\end{displaymath}

		\begin{displaymath}
			v_{Verzögerungskabel} = (\textcolor{red}{WERT} \pm \textcolor{red}{FEHLER}) \frac{m}{s}
		\end{displaymath}

		Die Fehler ergeben sich mithilfe Gaußscherfehlerfortpflanzung. Da die Messung der Länge des Verzögerungskabels ungenau war, wurde eine Messreihe von
	...
	\subsection{Messung der Ausbreitungsgeschwindigkeit mithilfe von stehenden Wellen}
		...
		\\
		\textcolor{red}{ABBBILDUNGEN HINZUFÜGEN!!! ES SIND KEINE JPGs, HELP!} 
		\\
		...
		Der Fehler der Frequenz wurde der Anleitung des Oszilloskops (\textcolor{blue}{HIER HYPERLINK EINFÜGEN ANLEITUNG OSZI}) entnommen.\\
		...
		$\lambda$ (in m) 					&     f (in kHz)  		&     v (in $\frac{m}{s}$) 	& $\epsilon_r$ \\
		\hline
  		 $\frac{\lambda}{4}$ 				&     ---------- 		&     ---------- 			& ---------- \\
		...
		\textcolor{red}{HIER NOCH VERGLEICH GEMESSENE WERTE MIT LITERATURWERTEN. KABELTYP RG213/U GOOGEL UND VGL SHEESH}
	...
	dass die LED bei der Startposition $s_LED = $\textcolor{red}{LÄNGE EINFÜGEN} steht.
	...
	Messreihe: 
	\begin{equation*}
		c = (\textcolor{red}{BESTWER} \pm \textcolor{red}{FEHLER}) \cdot 10^8\frac{m}{s}
	\end{equation*}

	Der Bestwert stimmt mit dem Literaturwert $c_{Literaturwert} = 299792458 \frac{m}{s}$ \cite{Lichtgeschwindigkeit}
...
\bibitem{Lichtgeschwindigkeit}
	https://physics.nist.gov/cgi-bin/cuu/Value?c, besucht am 18.11.2025 um 16.29 Uhr
\bibitem{b} 
