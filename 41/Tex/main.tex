...
\vspace{1em}
Das ist ein Abstract und hier wird abstrahiert.
\end{abstract}
}]
...
\section{Experiment und Auswertung}
	...
	\subsection{Signalübertragung auf Koaxialkabel bei verschiedenartiger Anpassung}
		...
		Voltmeter gemessen.\\
		Bei der Messung ergab das ein Widerstand von $R_v = Z = (50,0 \pm 1,0)\Omega$. Der Fehler des Voltmeters wurde dem Datenblatt (\textcolor{blue}{HIER HYPERLINK ZU DATENBLATT}) entnommen.
	...
	\begin{figure}[h]
		...
		\subfloat[\centering max. Reflexion, $R_v = 2{,}8\Omega$]{
			\includegraphics[angle=90, width=2cm]{../Images/ALL0013/F0013TEK.JPG}
		}%
		\qquad
		\subfloat[\centering keine Reflexion, $R_v = 50\Omega$]{
			\includegraphics[angle=90, width=2cm]{../Images/ALL0014/F0014TEK.JPG}
		}%
		\qquad
		\subfloat[\centering wenig Reflexion, $R_v = 94{,}3\Omega$]{
			\includegraphics[angle=90, width=2cm]{../Images/ALL0015/F0015TEK.JPG}
		}%
	...
	\end{figure}
		...
		\begin{figure}[h]
    		\centering
   			 \subfloat[\centering  $R_v = 0,1\Omega$]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0016/F0016TEK.JPG} }}%
    		\qquad
   			 \subfloat[\centering $R_v = 50\Omega$]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0017/F0017TEK.JPG} }}%
			\qquad
   			 \subfloat[\centering $R_v = 100,1\Omega$]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0018/F0018TEK.JPG} }}%
		...
		\begin{figure}[h]
    		\centering
   			 \subfloat[\centering $R_v = 0\Omega$]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0019/F0019TEK.JPG} }}%
    		\qquad
   			 \subfloat[\centering $R_v = 50\Omega$]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0020/F0020TEK.JPG} }}%
			\qquad
   			 \subfloat[\centering $R_v = 100\Omega$]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0021/F0021TEK.JPG} }}%
		...
		\begin{figure}[h]
			\centering
			\includegraphics[angle=90, width=3cm]{../Images/ALL0023/F0023TEK.JPG}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[angle=90, width=3cm]{../Images/ALL0022/F0022TEK.JPG}
		...
		\begin{figure}[h]
    		\centering
   			 \subfloat[\centering i \label{i}]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0024/F0024TEK.JPG} }}%
    		\qquad
   			 \subfloat[\centering ii \label{ii}]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0025/F0025TEK.JPG} }}%
			\qquad
   			 \subfloat[\centering iii \label{iii}]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0026/F0026TEK.JPG} }}%
		...
		\begin{figure}[h]
    		\centering
   			 \subfloat[\centering iv \label{iv}]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0027/F0027TEK.JPG} }}%
    		\qquad
   			 \subfloat[\centering v \label{v}]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0028/F0028TEK.JPG} }}%
			\qquad
   			 \subfloat[\centering vi \label{vi}]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0029/F0029TEK.JPG} }}%
		...
		\begin{figure}[h]
    		\centering
   			 \subfloat[\centering vii \label{vii}]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0030/F0030TEK.JPG} }}%
    		\qquad
   			 \subfloat[\centering viii \label{viii}]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0031/F0031TEK.JPG} }}%
			\qquad
   			 \subfloat[\centering ix \label{ix}]{{\includegraphics[angle=90, width=2cm]{../Images/ALL0032/F0032TEK.JPG} }}%
		...
		\begin{figure}[h]
			\centering
			\includegraphics[angle=90, width=3.5cm]{../Images/ALL0033/F0033TEK.JPG}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[angle=90, width=3.5cm]{../Images/ALL0037/F0037TEK.JPG}
	...
	\subsection{Messung der Ausbreitungsgeschwindigkeit mithilfe von stehenden Wellen}
		...
		\begin{figure}[h]
			...
			\subfloat[\centering konst. Interferenz \label{321Konst}]{
				\includegraphics[width=2cm]{../Images/ALL0034/F0034TEK.png}
			}%
			\qquad
			\subfloat[\centering asym. Amplitude \label{321Asym}]{
				\includegraphics[width=2cm]{../Images/ALL0035/F0035TEK.png}
			}%
			\qquad
			\subfloat[\centering dest. Interferenz \label{321Dest}]{
				\includegraphics[width=2cm]{../Images/ALL0036/F0036TEK.png}
			}%
		...
		$\lambda$ (in m) 					&     $f$ (in Hz)  		&     v (in $\frac{m}{s}$) 	& $\epsilon_r$ \\
		\hline
  		 $\frac{\lambda}{4}$ 				&     ($937991,0 \pm 3,1$)		&     $(11724,888 \pm 0,039)\cdot 10^3$ 			& ---------- \\

		 $\frac{\lambda}{2}$ 				&     ($1891980,0 \pm 4,4$)	&     $(47299,50 \pm 0,11)\cdot 10^3$ 			& ---------- \\

		 $\frac{3 \cdot \lambda}{4}$ 		&     ($2874970,0 \pm 5,4$) 		&     $(107811,38 \pm 0,20)\cdot 10^3$ 			& ---------- \\
		...
		\subsubsection{Bestimmung der Dämpfung des Signals im Koaxialkabel}
			...
			\begin{table}[htbp]          %so funktionieren die Tabellen in LaTeX
				\centering
				\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}c|c|c|c}
				$\lambda$ (in $m$) 					& $U(x)$ (in $V$) & $D$ (in $dB$)\\
				\hline
				$\frac{\lambda}{4}$ 				& $(14,20 \pm 0,45)\cdot 10^{-3}$ & $(21,0 \pm 1,4)$\\
				$\frac{\lambda}{2}$ 				& $(21,8 \pm 1,1)\cdot 10^{-3}$ & $(17,3 \pm 1,4)$\\
				$\frac{3 \cdot \lambda}{4}$ 		& $(26,4 \pm 1,1)\cdot 10^{-3}$ & $(15,7 \pm 1,4)$\\
				\end{tabular*}  
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=6cm]{../Images/DoverF.png}
...
\end{equation*}
 ...
 \begin{equation*}
	v_{\frac{\lambda}{4}} = (\textcolor{red}{WERT} \pm \textcolor{red}{FEHLER}) \cdot 10^6 \frac{m}{s} 
	v_{\frac{\lambda}{2}} = (\textcolor{red}{WERT} \pm \textcolor{red}{FEHLER}) \cdot 10^6 \frac{m}{s} 
	v_{\frac{3\lambda}{4}} = (\textcolor{red}{WERT} \pm \textcolor{red}{FEHLER}) \cdot 10^6 \frac{m}{s} 
 \end{equation*}
 \textcolor{red}{EVENTUELL EQUATION FIXEN WEIL ALLES IN EINER ZEILE}\\
