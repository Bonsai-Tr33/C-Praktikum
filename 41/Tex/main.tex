...
\vspace{1em}
	...
	An einem Koaxialkabel des Typs RG213/U wird durch Reflexionsunterdrückung der Wellenwiderstand $Z = (50,0 \pm 1,0)\Omega$ bestimmt. Das Reflexionsverhalten wird durch benutzen
...
\section{Einleitung}
	...
	Diese Arbeit beschäftigt sich damit, diese Eigenschaften von Koaxialkabel zu genauer beleuchten, deren Hintergrund zu verstehen und auch ein Umgang mit Koaxialkabeln
	zu erlernen.\\
...
\section{Theorie}
	...
	\subsection{Wellenausbreitung auf Kabeln}
		...
		\subsubsection{Mathematische Beschreibung einer Welle} \label{MathWell}
			...
			\begin{equation*}
				v = \frac{1}{L*C*} = \frac{c}{\sqrt{\mu_r \epsilon_r}}
...
\section{Experiment und Auswertung}
	...
	\subsection{Signalübertragung auf Koaxialkabel bei verschiedenartiger Anpassung}
		...
		Zunächst wurde am Funktionsgenerator eine Frequenz $f = 200 \, kHz$, eine Impulsbreite von $t = 20ns$ und eine Spannung von $U_{pp} = 10V$ eingestellt. Mittels T-Stecker
		wird das 50m lange Koaxialkabel sowohl mit dem Funktionsgenerator als auch mit dem Oszilloskop verbunden. 
	...
	\subsection{Messung der Ausbreitungsgeschwindigkeit mithilfe von stehenden Wellen}
		...
		\begin{table}[htbp]          %so funktionieren die Tabellen in LaTeX
			...
			$\lambda$ (in $m$) 					&     $f$ (in $Hz$)  			&     $v$ (in $10^6 \, \frac{m}{s}$) 		& $\epsilon_r$ \\
			\hline
			$\frac{\lambda}{4}$ 				&     ($937991,0 \pm 3,1$)		&     $(187,598200 \pm 0,000625)$ 			& $(2,553783 \pm 0,000017)$ \\

			$\frac{\lambda}{2}$ 				&     ($1891980,0 \pm 4,4$)		&     $(189,19800 \pm 0,00044)$ 			& $(2,510778 \pm 0,000012)$ \\

			$\frac{3 \cdot \lambda}{4}$ 		&     ($2874970,0 \pm 5,4$) 	&     $(191,66467 \pm 0,00036)$ 			& $(2,4465680 \pm 0,0000092)$ \\
		...
		\end{table}
		\textcolor{red}{FORMAT TABELLE ÜBERDENKEN}
		Vergleicht man nun die gemessene Ausbreitungsgeschwindigkeit mit den Literaturwerten des RG214/U Kabels, zeigt sich, dass dieses Koaxialkabel
		eine Ausbreitungsgeschwindigkeit von $~66\%$\\ der Lichtgeschwindigkeit besitzt, während nach unsere Messungen es ~63\%-64\% der Lichtgeschwindigkeit
		...
		\textcolor{red}{Hier noch bissi ausarbeiten, mach ich morgen}
...
\bibitem{Koaxialkabel}
	https://kabel-kusch.de/storage/276/01K4CBCD32TZ3J5E6MXYEJXR9E.pdf, besucht am 20.11.2025 um 00.53 Uhr
\bibitem{Koaxialkabel2}
	https://docs.rs-online.com/75d1/A700000011339821.pdf, besucht am 20.11.2025 um 00.59 Uhr
\end{thebibliography}
