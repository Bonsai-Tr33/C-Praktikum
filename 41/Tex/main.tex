...
\section{Theorie}
	...
	\subsection{Wellenausbreitung auf Kabeln}
		...
		\subsubsection{Mathematische Beschreibung einer Welle}
			Im Fall 2.1.2.1 (Kurzschluss der Leitung) oder 2.1.2.2 (Offenes Ende der Leitung) kommt es am Ende des Signals zu einer Reflexion.
			Wenn zwei Wellen gleicher Frequenz und Amplitude sich überlagern entsteht eine stehende Welle, 
			...
			\end{split}
			\end{equation*}
			Die resultierende Welle zeigt (im Idealfall) Orte, an denen die Amplitude konstant 0 ist (sog. Knoten).
			Im Fall eines Koaxialkabels kommt es jedoch zu Dämpfung, weshalb die Knoten endliche Werte die jedoch ungleich 0 sind werden.
