...
\section{Experiment und Auswertung}
	...
	dass die LED bei der Startposition $s_LED = (23,150 \pm 0,050) \, cm$ steht.
	...
	Der Bestwert stimmt mit dem Literaturwert $c_{Literaturwert} = 299792458 \, \frac{m}{s}$ \cite{Lichtgeschwindigkeit} (also $c \approx 300 \cdot 10^{6}$)
