...
\section{Experiment und Auswertung}
	...
	\subsection{Messung der Ausbreitungsgeschwindigkeit mithilfe von stehenden Wellen}
		...
		\begin{table}[H]          %so funktionieren die Tabellen in LaTeX
			...
			$\lambda$ (in $m$) 					&     $f$ (in $10^{3} \, Hz$)	&     $v$ (in $10^6 \, \frac{m}{s}$)	& $\epsilon_r$ \\
			\hline
			$\frac{\lambda}{4}$ 				&     ($938,0 \pm 1,9$)			&     $(187,60 \pm 0,38)$ 				& $(2,554 \pm 0,010)$ \\

			$\frac{\lambda}{2}$ 				&     ($1892,0 \pm 5,2$)	 	&     $(189,20 \pm 0,52)$ 				& $(2,511 \pm 0,014)$ \\

			$\frac{3 \cdot \lambda}{4}$ 		&     ($2875,0 \pm 1,9$) 		&     $(191,66 \pm 0,13)$ 				& $(2,4466 \pm  0,0033)$ \\
