...
\section{Experiment und Auswertung}
	...
	\subsection{Messung der Ausbreitungsgeschwindigkeit mithilfe von stehenden Wellen}
		...
		\subsubsection{Bestimmung der Dämpfung des Signals im Koaxialkabel}
			...
			\textcolor{red}{Die Abhängigkeit zwischen Frequenz und Dämpfung ist jedoch falsch. Normalerweise müsste die Dämpfung mit der Frequenz ansteigen. 
			Dieser falsche Zusammenhang liegt an der Ungenauigkeit unserer Messmethode. 
			Vor allem die Bestimmung der Knoten ist unpräzise und der Nullpunk $U(0)$ wurd nur einmal bestimmt.}
